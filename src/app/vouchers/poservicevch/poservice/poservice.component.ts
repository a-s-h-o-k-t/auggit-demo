...
export class PoserviceComponent implements OnInit {
  ...
  constructor(public poapi: PoserviceService, public fb: FormBuilder, public dialog: MatDialog, public router: Router) {}
  ...
  {
    return new Promise((resolve) => { 
      this.poapi.getMaxInvoiceNo(this.vchType,this._branch,this._fy,this._fyname).subscribe(res=>{
          this.pono = res;
          resolve({ action: 'success' });
      })
    });
