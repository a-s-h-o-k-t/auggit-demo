...
export class SovoucherComponent implements OnInit {
  ...
  {     
    ...
    if(this.tpValue == "" || this.tpValue == null || this.tpValue == undefined){this.tpValue="0";}
    if(this.pkValue == "" || this.pkValue == null || this.pkValue == undefined){this.pkValue="0";}
    if(this.insValue == "" || this.insValue == null || this.insValue == undefined){this.insValue="0";}  
    ...
    if(this.nettotal =='NaN' || this.nettotal == "" || this.nettotal == null || this.nettotal == undefined){this.nettotal="0";}
    if(this.tcsrate =='NaN' || this.tcsrate == "" || this.tcsrate == null || this.tcsrate == undefined){this.tcsrate="0";}
    if(this.tcsvalue =='NaN' || this.tcsvalue == "" || this.tcsvalue == null || this.tcsvalue == undefined){this.tcsvalue="0";}
  ...
  constructor(public salesapi: SalesService, public soapi: SoService, public fb: FormBuilder, 
    public dialog: MatDialog,public api:ApiService,public router:Router) {} 
