...
export class GrnserviceupdateComponent implements OnInit {
  ...
  constructor(public grnapi: GrnserviceService, public fb: FormBuilder, public dialog: MatDialog, 
    public api:ApiService, public router: Router, public poapi: PoserviceService, public activatedRoute:ActivatedRoute) {}
  ...
  {
    // return new Promise((resolve) => { 
    //   this.grnapi.getMaxInvoiceNo().subscribe(res=>{
    //       this.invno = res;
    //       resolve({ action: 'success' });
    //   })
    // });
  ...
  gotoGrnList()
  {
    this.router.navigateByUrl("servicegrnlist");
  }
