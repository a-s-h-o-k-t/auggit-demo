...
export class SalesupdateComponent implements OnInit {
  ...
  constructor(public salesapi: SalesService, public fb: FormBuilder, public dialog: MatDialog, public api:ApiService,public soapi:SoService,
 ...
 var totqty = parseFloat(qty);      
         ...
         this.salesapi.Delete_SalesDetails(this.invno,this.vchtype).subscribe(res=>{  
           this.salesapi.Delete_Accounts(this.invno,this.vchtype).subscribe(res=>{  
              this.salesapi.Delete_SavedDefSalesFields(this.invno,this.vchtype).subscribe(res=>{   
                this.salesapi.Delete_overdue(this.invno,this.vchtype).subscribe(res=>{  
                 resolve({ action: 'success' });
                });    
              });    
           });    
  ...
  showPendingSODetails()
  {
      ...
      dialogRef.afterClosed().subscribe(result=>{  
        ...
        this.emprtyGrid();
        data.forEach((v:any) => {                      
            this.addDataRow(v.pcode,v.pname,v.sku,v.hsn,v.godown,v.pqty,v.qtymt,v.rate,v.disc,v.tax);
        });
