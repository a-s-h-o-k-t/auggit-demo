...
export class SalesComponent implements OnInit {
  ...
  constructor(public salesapi: SalesService, public fb: FormBuilder, public dialog: MatDialog, 
    public api:ApiService,public soapi:SoService, public router: Router) {}
  ...
  {  
    return new Promise((resolve) => { 
      this.salesapi.getMaxInvoiceNo(this.vchtype,this._branch,this._fy,this._fyname).subscribe(res=>{
          this.invno = res;
          resolve({ action: 'success' });
      })
    });
  ...
  insertGrnDetails()
  {
    ...
    return new Promise((resolve) => { 
      if(this.pono == "" || this.pono == undefined){ this.pono = "";}
