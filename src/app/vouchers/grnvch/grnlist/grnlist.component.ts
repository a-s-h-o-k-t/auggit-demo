...
export class GrnlistComponent implements OnInit {
  ...
  constructor(public grnapi:GrnService, public poapi:PoService,public router: Router, public dialog : MatDialog) { }
  ...
  editpo(data:any)
  {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if(result) {
        this.router.navigateByUrl("grnupdate/" + data.grnno);
      }
    });      
  }
