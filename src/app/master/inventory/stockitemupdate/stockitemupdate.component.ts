...
@Component({
  selector: 'app-stockitemupdate',
  templateUrl: './stockitemupdate.component.html',
  styleUrls: ['./stockitemupdate.component.scss']
})
export class StockitemupdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.api.get_ItemDataWithID(this.oldID).subscribe(res=>{
      ...
      this.itemsku = res.itemsku;
      this.itemhsn = res.itemhsn;
      this.itemundercode = res.itemunder;
      this.itemcatcode= res.itemcategory;
      this.itemuomcode = res.uom;
      this.taxabletype = res.taxabletype;
      this.gst = res.gst;
      this.cess = res.cess;
      this.typeofsupply = res.typeofSupply;
    })
  }
  ...
  {  
    ...
    setTimeout(() => {                   
        ...
        this.api.Update_ItemData(this.oldID,postData).subscribe(data => {                     
